...
CKPT_PATH = '/home/yimu/project/FPN_Tensorflow-master/output/trained_weights/FPN_Res101_20190808/voc_120000model.ckpt'
OUT_DIR = '../../output/Pbs/'
PB_NAME = '0809.pb'
...
def build_detection_graph():
    ...
    input_str = tf.placeholder(tf.string, name='input_string')
    img_plac = tf.image.decode_jpeg(input_str, channels=3)
