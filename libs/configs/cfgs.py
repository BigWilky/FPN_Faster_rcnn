...
INFERENCE_IMAGE_PATH = ROOT_PATH + 'data/VOCdevkit/VOCdevkit_test/JPEGImages'
INFERENCE_SAVE_PATH = ROOT_PATH + '/data/VOCdevkit/inference_results'
...
test_annotate_path = ROOT_PATH + '/Data/VOCdevkit/VOCdevkit_test/Annotations'
...
DECAY_STEP = [60000, 80000]  # 60000, 80000
MAX_ITERATION = 150000 #150000
