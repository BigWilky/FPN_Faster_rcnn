...
def parse_args():
    ...
    parser.add_argument('--eval_imgs', dest='eval_imgs',
                        ...
                        default='/home/yimu/project/FPN_Tensorflow-master/data/VOCdevkit/VOCdevkit_test/JPEGImages/', type=str)
    parser.add_argument('--annotation_dir', dest='test_annotation_dir',
                        help='the dir save annotations',
                        default='/home/yimu/project/FPN_Tensorflow-master/data/VOCdevkit/VOCdevkit_test/Annotation/', type=str)
